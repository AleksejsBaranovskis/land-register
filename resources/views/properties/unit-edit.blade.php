        ...
        <form action="/properties/{{$property->id}}/units" method="POST">
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    name="cadastral_nr"
                    value="{{$unit->getLandUnitZerofill()}}"
                />
                @error('cadastral_nr')
            ...
            <div class="mb-6">
                ...
                >
                    <option disabled selected value>{{$unit->getLandUnitType($unit->land_usage_id)}}</option>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{$property->getLandPropertyZerofill()}}"
                    placeholder="Example: 11019020145"
                />
            ...
            <div class="mb-6">
                ...
                <a href="/properties/{{$property->id}}/units" class="text-black ml-4"> Back </a>
            </div>
        </form>
    </div>
</x-layout>
